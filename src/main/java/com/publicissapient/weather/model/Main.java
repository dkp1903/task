...
public class Main {
     ...
     * Sets the temp min.
     *
     * @param temp_min the new temp min
     */
     ...
     * Sets the temp max.
     *
     * @param temp_max the new temp max
     */
     ...
     * Sets the sea level.
     *
     * @param sea_level the new sea level
     */
     ...
     * Sets the grnd level.
     *
     * @param grnd_level the new grnd level
     */
